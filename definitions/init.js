...
ON('ready', function() {
	...
	COMPONENTATOR('webui', 'exec,errorhandler,locale,uibuilder,uistudio,directory,message,approve,datepicker,menu,icons,input,imageviewer,mobilecarousel,cookie2', true);
