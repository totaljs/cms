...
ON('ready', function() {
	...
	COMPONENTATOR('webui', 'errorhandler,exec,locale,uibuilder,uistudio,directory,message,approve,datepicker,menu,icons,input,imageviewer,mobilecarousel,markdown', true);
